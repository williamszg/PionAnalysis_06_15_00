...
// Fri Mar 24 16:17:30 2017 by ROOT version 6.06/08
// from TTree anatree/analysis tree
// found on file: /lariat/data/users/jasaadi/RunII_PosPol_06_15_00/RunIIPosData_06_15_00.root
//////////////////////////////////////////////////////////

#ifndef RunIIPosData_h
#define RunIIPosData_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           t0;
   Int_t           nclus;
   Double_t        clustertwire[1270];   //[nclus]
   Double_t        clusterttick[1270];   //[nclus]
   Double_t        cluendwire[1270];   //[nclus]
   Double_t        cluendtick[1270];   //[nclus]
   Int_t           cluplane[1270];   //[nclus]
   Int_t           ntracks_reco;
   Double_t        trkvtxx[388];   //[ntracks_reco]
   Double_t        trkvtxy[388];   //[ntracks_reco]
   Double_t        trkvtxz[388];   //[ntracks_reco]
   Double_t        trkendx[388];   //[ntracks_reco]
   Double_t        trkendy[388];   //[ntracks_reco]
   Double_t        trkendz[388];   //[ntracks_reco]
   Double_t        trkstartdcosx[388];   //[ntracks_reco]
   Double_t        trkstartdcosy[388];   //[ntracks_reco]
   Double_t        trkstartdcosz[388];   //[ntracks_reco]
   Double_t        trkenddcosx[388];   //[ntracks_reco]
   Double_t        trkenddcosy[388];   //[ntracks_reco]
   Double_t        trkenddcosz[388];   //[ntracks_reco]
   Int_t           trkWCtoTPCMatch[388];   //[ntracks_reco]
   Double_t        trklength[388];   //[ntracks_reco]
   Double_t        trkmomrange[388];   //[ntracks_reco]
   Double_t        trkmommschi2[388];   //[ntracks_reco]
   Double_t        trkmommsllhd[388];   //[ntracks_reco]
   Int_t           ntrkhits[388];   //[ntracks_reco]
   Double_t        trkx[388][1000];   //[ntracks_reco]
   Double_t        trky[388][1000];   //[ntracks_reco]
   Double_t        trkz[388][1000];   //[ntracks_reco]
   Double_t        trkpitch[388][2];   //[ntracks_reco]
   Int_t           trkhits[388][2];   //[ntracks_reco]
   Double_t        trkdedx[388][2][1000];   //[ntracks_reco]
   Double_t        trkdqdx[388][2][1000];   //[ntracks_reco]
   Double_t        trkrr[388][2][1000];   //[ntracks_reco]
   Double_t        trkpitchhit[388][2][1000];   //[ntracks_reco]
   Double_t        trkxyz[388][2][1000][3];   //[ntracks_reco]
   Double_t        trkke[388][2];   //[ntracks_reco]
   Double_t        trkpida[388][2];   //[ntracks_reco]
   Int_t           nTrajPoint[388];   //[ntracks_reco]
   Double_t        pHat0_X[388][1000];   //[ntracks_reco]
   Double_t        pHat0_Y[388][1000];   //[ntracks_reco]
   Double_t        pHat0_Z[388][1000];   //[ntracks_reco]
   Double_t        trjPt_X[388][1000];   //[ntracks_reco]
   Double_t        trjPt_Y[388][1000];   //[ntracks_reco]
   Double_t        trjPt_Z[388][1000];   //[ntracks_reco]
   Int_t           trkg4id[388];   //[ntracks_reco]
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[38978];   //[nhits]
   Int_t           hit_wire[38978];   //[nhits]
   Int_t           hit_channel[38978];   //[nhits]
   Double_t        hit_peakT[38978];   //[nhits]
   Double_t        hit_charge[38978];   //[nhits]
   Double_t        hit_ph[38978];   //[nhits]
   Double_t        hit_tstart[38978];   //[nhits]
   Double_t        hit_tend[38978];   //[nhits]
   Int_t           hit_trkid[38978];   //[nhits]
   Int_t           hit_trkkey[38978];   //[nhits]
   Int_t           hit_clukey[38978];   //[nhits]
   Int_t           hit_pk[38978];   //[nhits]
   Int_t           hit_t[38978];   //[nhits]
   Int_t           hit_ch[38978];   //[nhits]
   Int_t           hit_fwhh[38978];   //[nhits]
   Double_t        hit_rms[38978];   //[nhits]
   Double_t        hit_nelec[38978];   //[nhits]
   Double_t        hit_energy[38978];   //[nhits]
   Float_t         hit_dQds[38978];   //[nhits]
   Float_t         hit_dEds[38978];   //[nhits]
   Float_t         hit_ds[38978];   //[nhits]
   Float_t         hit_resrange[38978];   //[nhits]
   Float_t         hit_x[38978];   //[nhits]
   Float_t         hit_y[38978];   //[nhits]
   Float_t         hit_z[38978];   //[nhits]
   Int_t           nwctrks;
   ...
   RunIIPosData(TTree *tree=0);
   virtual ~RunIIPosData();
...
#ifdef RunIIPosData_cxx
RunIIPosData::RunIIPosData(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/lariat/data/users/jasaadi/RunII_PosPol_06_15_00/RunIIPosData_06_15_00.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/lariat/data/users/jasaadi/RunII_PosPol_06_15_00/RunIIPosData_06_15_00.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/lariat/data/users/jasaadi/RunII_PosPol_06_15_00/RunIIPosData_06_15_00.root:/anatree");
...
RunIIPosData::~RunIIPosData()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t RunIIPosData::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t RunIIPosData::LoadTree(Long64_t entry)
{
...
void RunIIPosData::Init(TTree *tree)
{
...
void RunIIPosData::Show(Long64_t entry)
{
...
Int_t RunIIPosData::Cut(Long64_t entry)
{
