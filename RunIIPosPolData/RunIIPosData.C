#define RunIIPosData_cxx
#include "RunIIPosData.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>


int nEVENTS = 1329218;//<---Total amount of events within sample
...
// ============================================
TFile myfile("../histoROOTfiles_forPlots/RunIIPosPolData_histos.root", "RECREATE");
...
//for (Long64_t jentry=0; jentry<nEVENTStesting; jentry++)
   ...
   for (int mwctrk = 0; mwctrk < nwctrks; mwctrk++)
      ...
      for (int nTPCtrk = 0; nTPCtrk < ntracks_reco; nTPCtrk++)         
         ...
         DeltaY_WC_TPC_Track = FirstSpacePointY - (wctrk_YFaceCoor[mwctrk]* 0.1);//<---Note: *0.1 to convert to cm
