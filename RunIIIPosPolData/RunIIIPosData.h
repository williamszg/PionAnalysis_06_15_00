...
// Thu Mar 30 08:15:46 2017 by ROOT version 6.06/08
// from TTree anatree/analysis tree
// found on file: /lariat/app/users/zwilliam/PionAnalysis_06_15_00/ROOTFILES/RunIII_Combined_zwilliam.root
//////////////////////////////////////////////////////////

#ifndef RunIIIPosData_h
#define RunIIIPosData_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           t0;
   Int_t           nclus;
   Double_t        clustertwire[333];   //[nclus]
   Double_t        clusterttick[333];   //[nclus]
   Double_t        cluendwire[333];   //[nclus]
   Double_t        cluendtick[333];   //[nclus]
   Int_t           cluplane[333];   //[nclus]
   Int_t           ntracks_reco;
   Double_t        trkvtxx[80];   //[ntracks_reco]
   Double_t        trkvtxy[80];   //[ntracks_reco]
   Double_t        trkvtxz[80];   //[ntracks_reco]
   Double_t        trkendx[80];   //[ntracks_reco]
   Double_t        trkendy[80];   //[ntracks_reco]
   Double_t        trkendz[80];   //[ntracks_reco]
   Double_t        trkstartdcosx[80];   //[ntracks_reco]
   Double_t        trkstartdcosy[80];   //[ntracks_reco]
   Double_t        trkstartdcosz[80];   //[ntracks_reco]
   Double_t        trkenddcosx[80];   //[ntracks_reco]
   Double_t        trkenddcosy[80];   //[ntracks_reco]
   Double_t        trkenddcosz[80];   //[ntracks_reco]
   Int_t           trkWCtoTPCMatch[80];   //[ntracks_reco]
   Double_t        trklength[80];   //[ntracks_reco]
   Double_t        trkmomrange[80];   //[ntracks_reco]
   Double_t        trkmommschi2[80];   //[ntracks_reco]
   Double_t        trkmommsllhd[80];   //[ntracks_reco]
   Int_t           ntrkhits[80];   //[ntracks_reco]
   Double_t        trkx[80][1000];   //[ntracks_reco]
   Double_t        trky[80][1000];   //[ntracks_reco]
   Double_t        trkz[80][1000];   //[ntracks_reco]
   Double_t        trkpitch[80][2];   //[ntracks_reco]
   Int_t           trkhits[80][2];   //[ntracks_reco]
   Double_t        trkdedx[80][2][1000];   //[ntracks_reco]
   Double_t        trkdqdx[80][2][1000];   //[ntracks_reco]
   Double_t        trkrr[80][2][1000];   //[ntracks_reco]
   Double_t        trkpitchhit[80][2][1000];   //[ntracks_reco]
   Double_t        trkxyz[80][2][1000][3];   //[ntracks_reco]
   Double_t        trkke[80][2];   //[ntracks_reco]
   Double_t        trkpida[80][2];   //[ntracks_reco]
   Int_t           nTrajPoint[80];   //[ntracks_reco]
   Double_t        pHat0_X[80][1000];   //[ntracks_reco]
   Double_t        pHat0_Y[80][1000];   //[ntracks_reco]
   Double_t        pHat0_Z[80][1000];   //[ntracks_reco]
   Double_t        trjPt_X[80][1000];   //[ntracks_reco]
   Double_t        trjPt_Y[80][1000];   //[ntracks_reco]
   Double_t        trjPt_Z[80][1000];   //[ntracks_reco]
   Int_t           trkg4id[80];   //[ntracks_reco]
   Int_t           primarytrkkey;
   Int_t           nhits;
   Int_t           hit_plane[6635];   //[nhits]
   Int_t           hit_wire[6635];   //[nhits]
   Int_t           hit_channel[6635];   //[nhits]
   Double_t        hit_peakT[6635];   //[nhits]
   Double_t        hit_charge[6635];   //[nhits]
   Double_t        hit_ph[6635];   //[nhits]
   Double_t        hit_tstart[6635];   //[nhits]
   Double_t        hit_tend[6635];   //[nhits]
   Int_t           hit_trkid[6635];   //[nhits]
   Int_t           hit_trkkey[6635];   //[nhits]
   Int_t           hit_clukey[6635];   //[nhits]
   Int_t           hit_pk[6635];   //[nhits]
   Int_t           hit_t[6635];   //[nhits]
   Int_t           hit_ch[6635];   //[nhits]
   Int_t           hit_fwhh[6635];   //[nhits]
   Double_t        hit_rms[6635];   //[nhits]
   Double_t        hit_nelec[6635];   //[nhits]
   Double_t        hit_energy[6635];   //[nhits]
   Float_t         hit_dQds[6635];   //[nhits]
   Float_t         hit_dEds[6635];   //[nhits]
   Float_t         hit_ds[6635];   //[nhits]
   Float_t         hit_resrange[6635];   //[nhits]
   Float_t         hit_x[6635];   //[nhits]
   Float_t         hit_y[6635];   //[nhits]
   Float_t         hit_z[6635];   //[nhits]
   Int_t           nwctrks;
   ...
   RunIIIPosData(TTree *tree=0);
   virtual ~RunIIIPosData();
...
#ifdef RunIIIPosData_cxx
RunIIIPosData::RunIIIPosData(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/lariat/app/users/zwilliam/PionAnalysis_06_15_00/ROOTFILES/RunIII_Combined_zwilliam.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/lariat/app/users/zwilliam/PionAnalysis_06_15_00/ROOTFILES/RunIII_Combined_zwilliam.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/lariat/app/users/zwilliam/PionAnalysis_06_15_00/ROOTFILES/RunIII_Combined_zwilliam.root:/anatree");
...
RunIIIPosData::~RunIIIPosData()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t RunIIIPosData::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t RunIIIPosData::LoadTree(Long64_t entry)
{
...
void RunIIIPosData::Init(TTree *tree)
{
...
void RunIIIPosData::Show(Long64_t entry)
{
...
Int_t RunIIIPosData::Cut(Long64_t entry)
{
